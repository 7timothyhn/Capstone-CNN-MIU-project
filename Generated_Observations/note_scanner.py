...
def create_output_structure(sheet_path, classifier_path):
    ...
    base_dir = "Gernerated_Observations"
    counter = 1
...
def main():
    ...
    parser.add_argument("--output", help="Output image name (default: result.png)")
    ...
    result_image = os.path.join(
        output_dir, args.output if args.output else "result of scan.png"
    )
